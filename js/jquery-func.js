$(document).ready(function() {
	...
	jQuery("a[class*='et_video_lightbox']").click(function() {
		var et_video_href = jQuery(this).attr('href'), et_video_link;
	...
	$("#subscription").submit(function() {
		$.ajax({
			...
			success : function(response) {
				...
				$("#loadingNews").hide();
				$("#subscription #firstname, #subscription #emailaddr").val("");
			}
		})
		return false;
	});
	...
	$("#contact-form").submit(function() {
		$.ajax({
			...
			success : function(response) {
				...
				$("#loading").hide();
				$("#contact-form #name, #contact-form #email, #contact-form textarea").val("");
			}
		})
		return false;
	});
